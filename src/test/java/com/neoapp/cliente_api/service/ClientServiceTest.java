...
class ClientServiceTest {
  ...
  void testFindByCpf_ClientNotFound() {
    ...
    // When & Then
    clientNotFoundExceptions exception = assertThrows(clientNotFoundExceptions.class,
  ...
  void testClientByParameters_Success() {
    // Given
    ClienteFiltersDto filters = new ClienteFiltersDto("João", null, null, null, null, null, null, null, null,
        Optional.empty());
    Pageable pageable = PageRequest.of(0, 10);
    Page<Client> clientPage = new PageImpl<>(List.of(testClient), pageable, 1);
  ...
  void testClientByParameters_EmptyFilters() {
    // Given
    ClienteFiltersDto emptyFilters = new ClienteFiltersDto(null, null, null, null, null, null, null, null, null,
        Optional.empty());
    Pageable pageable = PageRequest.of(0, 10);
    Page<Client> clientPage = new PageImpl<>(List.of(testClient), pageable, 1);
